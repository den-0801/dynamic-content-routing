...
## cdn
```html
<script src="https://cdn.jsdelivr.net/npm/dynamic-content-routing@1.0.0"></script>
<!-- utils (optional) -->
<script src="https://cdn.jsdelivr.net/npm/dynamic-content-routing@1.0.0/dist/utils/index-umd.min.js"></script>
<!-- styles (optional) -->
<link href="https://cdn.jsdelivr.net/npm/dynamic-content-routing@1.0.0/dist/styles.min.css" rel="stylesheet">
```
